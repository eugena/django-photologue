...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'photologue_photo', ['title'])


        # Changing field 'Photo.title_slug'
        db.alter_column(u'photologue_photo', 'title_slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'Photo.title'
        db.alter_column(u'photologue_photo', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Photo.title_slug'
        db.alter_column(u'photologue_photo', 'title_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        ...
        db.create_unique(u'photologue_photo', ['title'])
    ...
    models = {
        ...
        u'photologue.photo': {
            ...
            'title_slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '250'}),
